...
public class ClientFrame extends javax.swing.JFrame {
    ...
    private void btnConnectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConnectActionPerformed
        ...
        if (method.equals("POST")) {
            try {
                ...
                str = addParameter("Operation", "Login", str);
                str = addParameter("accNum", acc ,str);
                str = addParameter("pass", pass,str);
               if(!str.equals("0")){
        ...
        if(method.equals("GET")){
            try {
                str = url+"?Operation=Login&accNum="+txtAccountNumber.getText()+"&pass="+txtPass.getText();
    ...
    private void btnSendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSendActionPerformed
        if (connected) {
            ...
            if (method.equals("POST")) {
                try {
                    str = "";
                    str = addParameter("accNum", AccountID, str);
                    str = addParameter("Operation", functionality, str);
                    str = addParameter("Amount", txtAmmount.getText(), str);
                    if (!str.equals("0")) {
                        result = DoHTTPPost(str);
                    } else {
                        JOptionPane.showMessageDialog(this, "Please Enter All TextFields", "ERROR", JOptionPane.ERROR_MESSAGE);
            ...
            if (method.equals("GET")) {
                try {
                    str = url + "?accNum=" + AccountID + "&Operation=" + functionality + "&Amount=" + txtAmmount.getText();
                    result = DoHTTPGet(str);
                } catch (Exception ex) {
                    Logger.getLogger(ClientFrame.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    private void btnResetPassActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnResetPassActionPerformed
        if (connected) {
            ...
            if (method.equals("POST")) {
                try {
                    str = "";
                    str = addParameter("Operation", "ChangePass", str);
                    str = addParameter("accNum", AccountID, str);
            ...
            if (method.equals("GET")) {
                try {
                    str = url + "?Operation=ChangePass&accNum=" +  AccountID + "&newPass=" + newPass;
                    result =DoHTTPGet(str);
                } catch (Exception ex) {
                    Logger.getLogger(ClientFrame.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    private void btnNewBalanceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNewBalanceActionPerformed
        if (connected) {
            ...
            if (method.equals("POST")) {
                try {
                    str = "";
                    str = addParameter("Operation", "getBalance", str);
                    str = addParameter("accNum", AccountID, str);
                   // str = addParameter("NewPass", newPass, str);
                    //str = addParameter("Ammount", txtAmmount.getText(),str);
                  //  if (!str.equals("0")) {
            ...
            if (method.equals("GET")) {
                try {
                    str = url + "?Operation=getBalance&accNum=" + AccountID;
                    result = DoHTTPGet(str);
                } catch (Exception ex) {
                    //Logger.getLogger(ClientFrame.class.getName()).log(Level.SEVERE, null, ex);
                    ex.printStackTrace();
    ...
    public String addParameter(String ps, String vs ,String dataStr)
  {
    ...
    private String phpUrl="http://127.0.0.1:80/snmp/Serverhttp.php" , jspUrl="http://127.0.0.1:10000/Servlet-Jsp-http/newjsp.jsp" , servletUrl="http://127.0.0.1:10000/Servlet-Jsp-http/NewServlet",url , method;
